...
import at.common.ConfigOtkrytieUI;
...
public class OtkrytieUI {

    @Step("Step1: Открыть browser Сhrome")
    public static void openBrowser(){
        baseURI = ConfigOtkrytieUI.getOtkrytieUIHost();
//        port = ConfigOtkrytieUI.getOtkrytieUIPort();
//        basePath = ConfigOtkrytieUI.getOtkrytieUIPath();
        //Открыть браузер
...
//        open(baseURI+port+basePath);
    ...
    public static void openCurrencyExMenu() {
    ...
    public static void compareDollarRates() {
    ...
    public static void compareEuroRates() {
